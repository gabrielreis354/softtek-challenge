...
import BadgeAI from '../Badge/BadgeAI.jsx';
...
const Hero = () => {
    const videosInfo = useMemo(() => [
        {
            youtubeId: "hXAfAjpD2R8",
            videoTitle: "Video Pitch 01",
            videoDescription: "O primeiro video pitch foi entregue no dia 16/05/2024 na plataforma On da FIAP. Foram abordados aspectos gerais do projeto como tecnologias utilizadas e principais benefícios do sistema. O video tem duração de 02:43.",
            thumbSrc: thumbVP1,
        },
        {
                              ...
                              <div className='frame-video'>
                                  <div onClick={handleClick} className='iframe-wrapper'>
                                      {!isPaused ? (
                                        ...
                                        <>
                                            <img src={videoInfo.thumbSrc} alt={`Thumbnail for ${videoInfo.videoTitle}`} />
